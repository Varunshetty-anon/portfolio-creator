...
export const EditorPanel: React.FC<EditorPanelProps> = ({ data, onChange, onPublish, isSaving, hasUnsavedChanges, onLogout }) => {
  ...
  const removeProject = (id: string, e: React.MouseEvent) => {
    ...
    if (window.confirm("Are you sure you want to delete this project? This action happens immediately.")) {
                      ...
                      >
                       ...
                       <div className="flex items-center gap-2 relative z-30">
                         <button 
                            ...
                            className="w-8 h-8 flex items-center justify-center hover:bg-red-500/10 hover:text-red-500 text-zinc-500 transition-colors rounded-full"
