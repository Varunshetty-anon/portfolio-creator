...
export const AmbientBackground = () => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-[#050505]">
      ...
      <div 
        className="absolute top-[20%] left-[10%] w-[60vw] h-[60vw] min-w-[400px] min-h-[400px] rounded-full opacity-[0.12] blur-[100px] md:blur-[160px] will-change-transform"
        style={{ 
      ...
      <div 
        className="absolute bottom-[10%] right-[-5%] w-[70vw] h-[70vw] min-w-[500px] min-h-[500px] rounded-full opacity-[0.08] blur-[120px] md:blur-[180px] will-change-transform"
        style={{ 
