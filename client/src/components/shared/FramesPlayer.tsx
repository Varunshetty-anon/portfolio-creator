...
export const FramesPlayer: React.FC<FramesPlayerProps> = ({
  ...
  const processedUrl = gdriveId && !gdriveError ? `https://frames-video-worker.varunshettyv7.workers.dev/api/v1/portfolio/drive-proxy/${gdriveId}?fallbackOrigin=${encodeURIComponent(window.location.origin)}&v=2` : url;
